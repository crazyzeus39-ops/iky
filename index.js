...
async function Starts() {
  ...
  const Mane = makeWASocket({
    ...
    'patchMessageBeforeSending': _0xe2631f => {
      const Manesz = !!(_0xe2631f.buttonsMessage || _0xe2631f.templateMessage || _0xe2631f.listMessage);
      if (Manesz) {
        _0xe2631f = {
          'viewOnceMessage': {
            'message': {
  ...
  if (true && !Mane.authState.creds.registered) {
    const exxs = await question("\n              ⣀⣤⣤⣶⣶⣶⣶⣦⣤⡀     \n       ⢀⣀⣤⣤⣄⣶⣿⠟⠛⠉   ⢀⣹⣿⡇      \n    ⢀⣤⣾⣿⡟⠛⠛⠛⠉    ⠒⠒⠛⠿⠿⠿⠶⣿⣷⣢⣄⡀ \n   ⢠⣿⡟⠉⠈⣻⣦  ⣠⡴⠶⢶⣄        ⠈⠙⠻⣮⣦\n  ⢰⣿⠿⣿⡶⠾⢻⡿ ⠠⣿⣄⣠⣼⣿⡇ ⠈⠒⢶⣤⣤⣤⣤⣤⣴⣾⡿\n  ⣾⣿ ⠉⠛⠒⠋   ⠻⢿⣉⣠⠟     ⠉⠻⣿⣋⠙⠉⠁ \n  ⣿⡿⠷⠲⢶⣄     ⣀⣤⣤⣀       ⠙⣷⣦   \n⠛⠛⢿⣅⣀⣀⣀⣿⠶⠶⠶⢤⣾⠋  ⠙⣷⣄⣀⣀⣀⣀⡀ ⠘⣿⣆  \n   ⠈⠉⠉⠉⠁    ⠈⠛⠛⠶⠾⠋⠉⠉⠉⠉⠉⠉⠉⠉⠛⠛⠛⠛ \n\n‹⧼ © " + namaBot + " ⧽›`\n‹⧼ Version " + versi + " ⧽›\n=========================================\n ❖ Mane ❖ \n╭────────────────╼\n╎Enter Your Number Here : \n╰────────────────╼ ");
    const hingga = await Mane.requestPairingCode(exxs, 'ZANSPIWW');
    console.log("\n╭────────────────╼\n╎ This Your Pairing Code : " + hingga + "\n╰────────────────╼");
  }
  store.bind(Mane.ev);
  Mane.ev.on('messages.upsert', async (_0x2e8e9a, _0x347d47) => {
    try {
      ...
      if (!Mane["public"] && !exams.key.fromMe && _0x2e8e9a.type === "notify") {
        return;
      }
      ...
      const _0x576aaa = smsg(Mane, exams, store);
      require('./Mane')(Mane, _0x576aaa, _0x2e8e9a, store);
    } catch (_0x399803) {
      console.log(_0x399803);
    }
  });
  Mane.decodeJid = _0x4a62e8 => {
    if (!_0x4a62e8) {
      return _0x4a62e8;
    }
  ...
  Mane.ev.on("contacts.update", _0xf7b9a3 => {
    for (let _0x5615e7 of _0xf7b9a3) {
      let _0x1ee349 = Mane.decodeJid(_0x5615e7.id);
  ...
  Mane['public'] = true;
  Mane.ev.on('connection.update', async _0x6e0f1f => {
    const {
...
await Mane.newsletterFollow("120363404768688477@newsletter");
  ...
  Mane.ev.on('group-participants.update', async _0x376a39 => {
    await (await import('./gc.js'))["default"](Mane, _0x376a39);
  });
  Mane.sendText = async (_0x421e16, _0x3e060a, _0x84e8be = '', _0x1e0a90) => {
    Mane.sendMessage(_0x421e16, {
      'text': _0x3e060a,
      ..._0x1e0a90
    }, {
      'quoted': _0x84e8be
  ...
  Mane.downloadMediaMessage = async _0x298bc1 => {
  ...
  Mane.sendImageAsSticker = async (_0x4271d4, _0x27ec11, _0x41f569, _0x2230cd = {}) => {
    ...
    await Mane.sendMessage(_0x4271d4, {
      'sticker': {
        'url': _0x115f25
      },
      ..._0x2230cd
  ...
  Mane.downloadAndSaveMediaMessage = async (_0x1e56f3, _0x4f1429, _0x5c1b2b = true) => {
  ...
  Mane.sendVideoAsSticker = async (_0xf30d81, _0x3e1a88, _0x12f607, _0x21f182 = {}) => {
    ...
    await Mane.sendMessage(_0xf30d81, {
      'sticker': {
        'url': _0x1e9825
      },
      ..._0x21f182
  ...
  Mane.albumMessage = async (_0x43f10c, _0x51cd60, _0x2f39a8) => {
    const _0x551448 = generateWAMessageFromContent(_0x43f10c, {
      ...
      'userJid': Mane.user.jid,
      'quoted': _0x2f39a8,
      'upload': Mane.waUploadToServer
    });
    await Mane.relayMessage(_0x43f10c, _0x551448.message, {
    ...
    for (let _0x217ee8 of _0x51cd60) {
      ...
      await Mane.relayMessage(_0x43f10c, _0x3938ae.message, {
  ...
  Mane.sendStatusMention = async (_0x43ab3b, _0x2fce06 = []) => {
    let _0x572458;
    for (let _0x27bb9f of _0x2fce06) {
      let _0x5d6ef2 = await Mane.groupMetadata(_0x27bb9f);
      _0x572458 = await _0x5d6ef2.participants.map(_0x8e2329 => Mane.decodeJid(_0x8e2329.id));
    }
    ;
    let _0x39369e = await Mane.sendMessage("status@broadcast", _0x43ab3b, {
  ...
  Mane.ev.on("creds.update", _0x10e480);
  return Mane;
}
Starts();
